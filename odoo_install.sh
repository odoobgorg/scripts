...
# Author: Kaloyan Naumov, based on Yenthe Van Ginneken script
#-------------------------------------------------------------------------------
...
IS_ENTERPRISE="False"
#set the Odoo superadmin password
OE_SUPERADMIN="admin"
...
# git clone --depth 1 --branch 9.0 https://www.github.com/odoobgorg/odoo 
# git clone https://github.com/odoobgorg/addons odoobgorg-addons
...
# git clone --depth 1 --branch 9.0 https://www.github.com/odoobgorg/odoo-enterprise
# https://github.com/odoobgorg/odoo
